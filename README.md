...
Pipeline
Fetch historical & live data from IBKR, Bloomberg, Databento, CBOE

Generate trading signals using mean-reversion & trend-following filters

Price spreads via Black-76 for futures options

Backtest with performance metrics: P&L, Sharpe, drawdown

Apply risk filters: volatility, macro events

Execute live or paper trades via IBKR API
...
Add macro event-driven entry filters
